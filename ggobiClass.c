  ...
  if (g_signal_lookup("brush_motion", GGOBI_TYPE_GGOBI) == 0) {
    GGobiSignals[BRUSH_MOTION_SIGNAL] =
      g_signal_new("brush_motion",
        ...
        G_TYPE_NONE, 3,
        GGOBI_TYPE_SPLOT,
        G_TYPE_POINTER, /* GdkEventMotion pointer */
        GGOBI_TYPE_DATA);
  }
  ...
  if (g_signal_lookup("sticky_point_added", GGOBI_TYPE_GGOBI) == 0) {
    GGobiSignals[STICKY_POINT_ADDED_SIGNAL] = 
      g_signal_new("sticky_point_added", 
        ...
        G_TYPE_NONE, 3, 
        G_TYPE_INT, G_TYPE_INT, GGOBI_TYPE_DATA); /* record index and datad pointer */
  }
...
GType ggobi_display_get_type(void)
{
  ...
  if (!display_type) {
    ...
    display_type = g_type_register_static(GTK_TYPE_VBOX, "GGobiDisplay", &display_info, 0);
  }
...
GType ggobi_window_display_get_type(void)
{
  ...
  if (!window_type) {
    ...
    window_type = g_type_register_static(GGOBI_TYPE_DISPLAY, "GGobiWindowDisplay", &window_info, 0);
  }
...
ggobi_embedded_display_get_type(void)
{
   ...
   if(!embedded_type) {
      ...
      embedded_type = g_type_register_static(GGOBI_TYPE_DISPLAY, "GGobiEmbeddedDisplay", &embedded_info, 0);
   }
...
ggobi_splot_get_type(void)
{
  ...
  if (!splot_type) {
    ...
    splot_type = g_type_register_static(GTK_TYPE_DRAWING_AREA, "GGobiSPlot", &splot_info, 0);
  }
...
GType ggobi_extended_splot_get_type(void)
{
  ...
  if (!splot_type) {
    ...
    splot_type = g_type_register_static(GGOBI_TYPE_SPLOT, "GGobiExtendedSPlot", &splot_info, 0);
  }
...
static void extendedDisplayClassInit(GGobiExtendedDisplayClass * klass)
{
...
GType ggobi_extended_display_get_type(void)
{
  static GType display_type = 0;
  ...
  if (!display_type) {
    ...
    display_type =
        g_type_register_static(GGOBI_TYPE_WINDOW_DISPLAY, "GGobiExtendedDisplay", &display_info, 0);
  }
...
GType ggobi_time_series_display_get_type(void)
{
  ...
  if (!time_series_type) {
    ...
    time_series_type =
        g_type_register_static(GGOBI_TYPE_EXTENDED_DISPLAY, "GGobiTimeSeriesDisplay", &time_series_info, 0);
  }
...
*/
    ...
    barchart_type =
        g_type_register_static(GGOBI_TYPE_EXTENDED_DISPLAY, "GGobiBarChartDisplay", &barchart_info, 0);
  }
...
GType ggobi_barchart_splot_get_type(void)
{
  ...
  if (!barchart_type) {
    ...
    barchart_type =
        g_type_register_static(GGOBI_TYPE_EXTENDED_SPLOT, "GGobiBarChartSPlot", &barchart_info, 0);
  }
...
GType ggobi_time_series_splot_get_type(void)
{
  ...
  if (!time_series_type) {
    ...
    time_series_type =
        g_type_register_static(GGOBI_TYPE_EXTENDED_SPLOT, "GGobiTimeSeriesSPlot", &time_series_info, 0);
  }
...
GType ggobi_par_coords_display_get_type(void)
{
  ...
  if (!par_coords_type) {
    ...
    par_coords_type =
        g_type_register_static(GGOBI_TYPE_EXTENDED_DISPLAY, "GGobiParCoordsDisplay", &par_coords_info, 0);
  }
...
GType ggobi_par_coords_splot_get_type(void)
{
  ...
  if (!par_coords_type) {
    ...
    par_coords_type =
        g_type_register_static(GGOBI_TYPE_EXTENDED_SPLOT, "GGobiParCoordsSPlot", &par_coords_info, 0);
  }
...
ggobi_scatter_splot_get_type(void)
{
  ...
  if (!scatter_plot_type)
  {
    ...
    scatter_plot_type = g_type_register_static(GGOBI_TYPE_EXTENDED_SPLOT, "GGobiScatterSPlot",
      &scatter_plot_info, 0);
  }
...
ggobi_scatterplot_display_get_type (void)
{
  ...
  if (!scatter_plot_type)
  {
    ...
    scatter_plot_type = g_type_register_static(GGOBI_TYPE_EXTENDED_DISPLAY, "GGobiScatterplotDisplay", 
		&scatter_plot_info, 0);
  }
...
ggobi_scatmat_splot_get_type(void)
{
  ...
  if (!scatmat_type)
  {
    ...
    scatmat_type = g_type_register_static(GGOBI_TYPE_EXTENDED_SPLOT, "GGobiScatmatSPlot",
      &scatmat_info, 0);
  }
...
ggobi_scatmat_display_get_type (void)
{
  ...
  if (!scatmat_type)
  {
    ...
    scatmat_type = g_type_register_static(GGOBI_TYPE_EXTENDED_DISPLAY, "GGobiScatmatDisplay",
		&scatmat_info, 0);
  }
