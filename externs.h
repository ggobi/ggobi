...
void br_line_vectors_check_size (gint, ggobid *);
...
gboolean collabels_read (gchar *, gboolean, datad *, ggobid *);
...
void cpanel_tour_init (cpaneld *, ggobid *);
...
void display_tailpipe (displayd *, ggobid *);
void display_tour_init (displayd *, ggobid *);
...
gboolean edges_read (gchar *, gboolean, datad *, ggobid *);
...
gboolean fileset_read (gchar *, ggobid *);
gboolean fileset_read_init (gchar *ldata_in, ggobid *);
...
void get_main_menu (GtkItemFactoryEntry[], gint, GtkAccelGroup *, GtkWidget  *, GtkWidget **, gpointer);
...
void line_brush_prev_vectors_update (ggobid *);
void line_brush_undo (splotd *, ggobid *);
gboolean line_colors_read (gchar *, gboolean, datad *, ggobid *);
...
void missing_values_read (gchar *, gboolean, datad *, ggobid *);
...
gboolean point_colors_read (gchar *, gboolean, datad *, ggobid *);
gboolean point_glyphs_read (gchar *, gboolean, datad *, ggobid *);
...
gboolean rowlabels_read (gchar *, gboolean, datad *, ggobid *);
...
void tour1d_event_handlers_toggle (splotd *, gboolean);
void tour1d_func (gboolean, ggobid *);
void tour1d_func (gboolean, ggobid *);
...
void tour2d_func (gboolean, ggobid *);
void tour2d_func (gboolean, ggobid *);
void tour2d_func (gboolean, ggobid *);
