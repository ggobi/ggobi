...
void       increment_tour(vector_f, vector_f, gint *, gint *, gfloat, gfloat, gfloat *, gint);
...
gint       path (array_d, array_d, array_d, gint, gint, array_d, array_d, array_d, vector_f, array_d, array_d, array_d, vector_f, vector_f, gint *, gint *, gfloat *, gfloat *, gfloat);
...
void       speed_set (gint, gfloat *, gfloat *, gint *, gint *);
...
gboolean   reached_target(gint, gint, gfloat, gfloat, gint, gfloat *, gfloat *);
