...
void edge_brush_prev_vectors_update (datad *d, ggobid *);
void edge_brush_undo (splotd *, datad *, ggobid *);
gboolean edge_colors_read (InputDescription *, gboolean, datad *, ggobid *);
