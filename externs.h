...
extern void brush_motion (icoords *, gboolean, gboolean, cpaneld *, ggobid *);
...
extern void missing_arrays_add_column (gint, datad *d, ggobid *);
...
extern void sphere_apply_cb (GtkWidget *, ggobid *);
