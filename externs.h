...
extern void brush_draw_brush (splotd *, ggobid *);
extern void brush_draw_label (splotd *, ggobid *);
...
extern gboolean brush_once (gboolean force, datad *d, ggobid *gg);
extern void brush_options_cb (gpointer, guint, GtkCheckMenuItem *);
extern void brush_pos_init (ggobid *);
extern void brush_set_pos (gint, gint, ggobid *);
...
extern void datad_init (datad *);
extern datad * datad_new (ggobid *);
extern displayd* dataset_init (datad *, ggobid *gg, gboolean cleanup);
...
extern void exclusion_window_open (datad *, ggobid *);
extern gint fcompare (const void *x1, const void *x2);
extern gboolean fileset_read (gchar *, datad *, ggobid *);
extern gboolean fileset_read_init (gchar *ldata_in, datad *, ggobid *);
...
extern gint get_vgroup_cols (gint, gint *, datad *, ggobid *);
extern void hidden_alloc (datad *, ggobid *);
extern void hidden_init (datad *, ggobid *);
extern gboolean hidden_read (gchar *, gboolean, datad *, ggobid *gg);
...
extern void jitter_window_open (datad *, ggobid *);
...
extern gint nspherevars_get (datad *, ggobid *);
extern gint nvgroups (datad *, ggobid *);
...
extern gint plotted_cols_get (gint *, gboolean, datad *, ggobid *);
...
extern displayd* scatterplot_new (gboolean, splotd *sp, datad *d, ggobid *gg);
extern void scatterplot_show_rulers (displayd *, gint);
extern gboolean scree_mapped_p (void);
extern gint selected_cols_get (gint *, gboolean, datad *d, ggobid *gg);
...
extern void sphere_apply_cb (GtkWidget *, ggobid *gg);
...
extern gint spherevars_get (gint *, datad *, ggobid *);
...
extern void subset_window_open (datad *d, ggobid *gg);
...
extern void vardata_alloc (datad *d, ggobid *);
extern void vardata_init (datad *d, ggobid *);
extern void vardata_lim_raw_gp_set (datad *, ggobid *);
extern void vardata_lim_update (datad *d, ggobid *);
extern void vardata_realloc (gint, datad *, ggobid *);
...
extern void varpanel_layout_init (datad *, ggobid *);
extern void varpanel_populate (datad *, ggobid *);
extern void varpanel_refresh (datad *, ggobid *);
...
extern void vartable_tform_set (gint, datad *, ggobid *);
...
extern gboolean vgroups_read (gchar *, gboolean, datad *, ggobid *);
extern void vgroups_sort (datad *, ggobid *);
...
extern gboolean updateAddedColumn (gint nc, gint jvar, datad *, ggobid *);
