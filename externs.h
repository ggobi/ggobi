...
extern displayd* parcoords_new (gboolean, gint, gint *, ggobid *);
...
extern gboolean pca_calc (ggobid *);
extern void pca_diagnostics_set (ggobid *);
extern gint pcompare (const void *, const void *);
extern void pipeline_arrays_add_column (gint, ggobid *);
extern void pipeline_arrays_alloc (ggobid *);
extern void pipeline_init (ggobid *);
extern gint plotted_cols_get (gint *, gboolean, ggobid *);
extern void point_brush_prev_vectors_update (ggobid *);
extern void point_brush_undo (splotd *, ggobid *);
...
extern displayd* scatmat_new (gboolean, gint, gint *, gint, gint *, ggobid *);
