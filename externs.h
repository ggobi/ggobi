...
GtkWidget* create_variable_notebook (GtkWidget *box, GtkSelectionMode mode, vartyped vtype, GtkSignalFunc func, ggobid *);
...
void       t1d_ppcool_set(gfloat, ggobid *);
...
void       t2d_pptemp_set(gfloat, ggobid *);
void       t2d_ppcool_set(gfloat, ggobid *);
...
void       variable_notebook_subwindow_add (datad *d, GtkSignalFunc func, GtkWidget *notebook, vartyped, ggobid *gg);
