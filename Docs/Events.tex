...
\begin{verbatim}
 void (*callback)(void *userData, datad *data, ggobid *gg, GtkWidget *w);
\end{verbatim}
\item[brush movement] 
...
instance.
\begin{verbatim}
 void (*callback)(void *userData, splotd *sp, GdkMotionEvent *ev, ggobid *gg, GtkWidget *w);
\end{verbatim}
...
\begin{verbatim}
void (*callback)(void *userData, ggobid *gg, splotd *sp, GdkEvetMotion* ev, GtkWidget *w,);
\end{verbatim}
...
\begin{verbatim}
void (*callback)(void *userData, gint whichVar, datad *d, splotd *sp, 
