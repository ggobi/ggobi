...
% a vertical variable. 
The tour modes all use a set of labeled
...
\begin{itemize}
\item The checkboxes aren't sufficiently informative -- in
  some projections, they really ought to indicate whether a variable is
  plotted vertically or horizontally.  We need a new widget, a richer
  kind of checkbox.
...
\item Graph layout  (currently being implemented as a plugin)
\end{itemize}
