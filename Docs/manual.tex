...
showing in the scatterplot window, the axis in magenta corresponds
to the variable you're manipulating.  Similarly rotate oleic acid
...
controls the bin width.  Line segments can be added that run between
