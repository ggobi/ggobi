...
If you are currently using \math{n} colors and the color scheme
you have selected
has fewer than \math{n} colors, you'll be prohibited from applying
...
count'' method attempts to map the values into \math{n} bins of equal
