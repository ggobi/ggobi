...
displayd *ggobi_par_coords_display_new(gint type, gboolean missing_p, GGobiStage *d, GGobiSession *gg);
...
splotd *ggobi_parcoords_splot_new(displayd *dpy, GGobiSession *gg);
