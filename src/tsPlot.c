...
static GdkSegment * tsAllocWhiskers(GdkSegment *, GGobiStage *d);
...
GdkSegment * 
tsAllocWhiskers(GdkSegment *whiskers, GGobiStage *d)
{
  return((GdkSegment *) g_realloc (whiskers, d->n_rows-1 * sizeof (GdkSegment)));
}
