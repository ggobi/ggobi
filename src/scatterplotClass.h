...
displayd *ggobi_scatterplot_display_new(gint type, gboolean missing_p, GGobiStage *d, GGobiSession *gg);
...
displayd *createScatterplot(displayd *, gboolean missing_p, splotd *sp, gint numVars, gint *vars, GGobiStage *d, GGobiSession *gg);
