...
void
ggobi_marshal_VOID__OBJECT_POINTER_OBJECT (GClosure     *closure,
                                           GValue       *return_value,
...
{
  typedef void (*GMarshalFunc_VOID__OBJECT_POINTER_OBJECT) (gpointer     data1,
                                                            gpointer     arg_1,
                                                            gpointer     arg_2,
                                                            gpointer     arg_3,
                                                            gpointer     data2);
  register GMarshalFunc_VOID__OBJECT_POINTER_OBJECT callback;
  ...
  callback = (GMarshalFunc_VOID__OBJECT_POINTER_OBJECT) (marshal_data ? marshal_data : cc->callback);
...
void
ggobi_marshal_VOID__OBJECT_INT_OBJECT (GClosure     *closure,
                                       GValue       *return_value,
                                       guint         n_param_values,
                                       const GValue *param_values,
                                       gpointer      invocation_hint,
...
void
ggobi_marshal_VOID__POINTER_INT_OBJECT (GClosure     *closure,
                                        GValue       *return_value,
                                        guint         n_param_values,
                                        const GValue *param_values,
                                        gpointer      invocation_hint,
...
void
ggobi_marshal_VOID__INT_INT_OBJECT (GClosure     *closure,
                                    GValue       *return_value,
                                    guint         n_param_values,
                                    const GValue *param_values,
                                    gpointer      invocation_hint,
