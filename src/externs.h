...
void pt_world_to_raw_by_var (gint j, gdouble *world, gdouble *raw, GGobiData *d);
...
void       do_last_increment (vector_f, vector_f, gdouble, gint);
...
void       eigenvals_get (gdouble *, GGobiData *);
...
gboolean   impute_fixed (ImputeType, gdouble val, int nvars, gint *vars, GGobiData *, ggobid *);
...
void       increment_tour(vector_f, vector_f, gdouble, gdouble, gdouble *, gint);
...
gdouble     jitter_randval (gint);
void       jitter_value_set (gdouble, GGobiData *, ggobid *);
...
void       p1d_reproject (splotd *, gdouble **, GGobiData *, ggobid *);
...
void       sphere_condnum_set (gdouble x, ggobid *);
...
void       sphere_variance_set (gdouble x, GGobiData *, ggobid*);
...
void       t1d_ppcool_set(gdouble, displayd *, ggobid *);
void       t1d_ppdraw(gdouble, displayd *, ggobid *);
void       t1d_pptemp_set(gdouble, displayd *, ggobid *);
void       t2d_clear_ppda (displayd *, ggobid *);
void       t2d_optimz (gint, gboolean *, gint *, displayd *);
void       t2d_pp_reinit(displayd *, ggobid *);
void       t2d_ppcool_set(gdouble, displayd *, ggobid *);
void       t2d_ppdraw (gdouble, displayd *, ggobid *);
void       t2d_pptemp_set(gdouble, displayd *, ggobid *);
void       textur (gdouble *, gdouble *, gint, gint, gdouble, gint, ggobid *);
...
void       tour1d_projdata (splotd *, gdouble **, GGobiData *, ggobid *);
...
void       tour1d_speed_set (gdouble, ggobid *);
...
void       tour2d3_projdata (splotd *, gdouble **world_data, GGobiData *, ggobid *);
void       tour2d3_reinit (ggobid *);
void       tour2d3_scramble (ggobid *);
void       tour2d3_speed_set (gdouble, ggobid *);
...
void       tour2d_projdata (splotd *, gdouble **, GGobiData *, ggobid *);
...
void       tour2d_speed_set (gdouble, ggobid *);
gboolean   tour2d_varsel (GtkWidget *, gint jvar, gint toggle, gint btn, GGobiData *, ggobid *);
void       tour2dpp_window_open (ggobid *);
gint       tour_path (array_d, array_d, array_d, gint, gint, array_d, array_d, array_d, vector_f, array_d, array_d, array_d, vector_f, vector_f, gdouble *, gdouble *);
...
void       tourcorr_projdata (splotd *, gdouble **, GGobiData *, ggobid *);
...
void       tourcorr_speed_set (gdouble, ggobid *);
gboolean   tourcorr_varsel (GtkWidget *, gint jvar, gint toggle, gint btn, GGobiData *, ggobid *);
void       transform (gint, gint, gdouble, gint *, gint, GGobiData *, ggobid *);
...
void       transform1_values_set (gint, gdouble, gint, GGobiData *, ggobid *);
...
gboolean   transform_variable (gint, gint, gdouble, gint, GGobiData *, ggobid *);
...
void       xy_reproject (splotd *, gdouble **, GGobiData *, ggobid *);
