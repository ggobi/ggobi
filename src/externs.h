...
void       addvar_propagate (gint ncols_prev, gint ncols_added, GGobiData *, ggobid *);
...
gboolean   array_contains (gint* arr, gint n, gint el);
gboolean   array_read (GGobiData *, InputDescription *,  ggobid *);
...
void       br_edge_color_init (GGobiData *d, ggobid *);
...
void       clone_vars (gint *cols, gint ncols, GGobiData *, ggobid *);
...
void       collab_tform_update (gint j, GGobiData *d, ggobid *gg);
gboolean   collabels_read (InputDescription *desc, gboolean, GGobiData *, ggobid *);
...
void       cpanel_rotation_set (displayd *, cpaneld *, ggobid *);
...
gint       delete_vars (gint *, gint, GGobiData *, ggobid *);
...
displayd*  display_create (gint displaytype, gboolean missing_p, GGobiData *, ggobid *);
...
void       edges_create (GGobiData *, ggobid *);
void       edges_free (GGobiData *, ggobid *);
gboolean   edges_read (InputDescription *desc, gboolean, GGobiData *, ggobid *);
...
gboolean   hidden_read (InputDescription *desc, gboolean, GGobiData *, ggobid *);
...
void       limits_set_by_var (gint, gboolean do_raw, gboolean do_tform, GGobiData *, ggobid *);  
...
void       missing_arrays_add_cols (GGobiData *d, ggobid *);
gboolean   missing_values_read (InputDescription *desc, gboolean, GGobiData *, ggobid *);
...
//GtkWidget *parcoords_pmode_menu_make (GtkAccelGroup *, GtkSignalFunc, ggobid *, gboolean);
//GtkWidget *parcoords_imode_menu_make (GtkAccelGroup *, GtkSignalFunc, ggobid *, gboolean);
...
gboolean  update_selected_vectors (gint i, gboolean changed, gboolean *hit_by_brush, GGobiData *d, ggobid *gg);
void       pipeline_arrays_add_column (gint, GGobiData *, ggobid *);
...
gboolean   point_colors_read (InputDescription *desc, gboolean, GGobiData *, ggobid *);
gboolean   point_glyphs_read (InputDescription *desc, gboolean, GGobiData *, ggobid *);
...
void populate_tree_view(GtkWidget *tree_view, gchar **lbl, gint nitems, gboolean headers,
...
//gboolean   rowlabels_read (InputDescription *desc, gboolean, GGobiData *, ggobid *);
...
//GtkWidget *scatterplot_pmode_menu_make (GtkAccelGroup *, GtkSignalFunc, ggobid *gg, gboolean);
//GtkWidget *scatterplot_imode_menu_make (GtkAccelGroup *, GtkSignalFunc, ggobid *gg, gboolean);
...
gint       sphere_npcs_get (GGobiData *, ggobid *);
...
void       tform_label_update (gint, GGobiData *, ggobid *);
...
void       tour1d_realloc_up (gint nc, GGobiData *d, ggobid *gg);
...
void       tour2d3_realloc_up (gint nc, GGobiData *d, ggobid *gg);
...
void       tour2d_realloc_up (gint nc, GGobiData *d, ggobid *gg);
...
void       tourcorr_realloc_up (gint nc, GGobiData *d, ggobid *gg);
...
void       variable_clone (gint, const gchar *, gboolean, GGobiData *, ggobid *);
...
gint       vartable_index_get_by_name (gchar *collab, GGobiData *d);
...
void       vartable_realloc (gint, GGobiData *);
void       vartable_row_append (gint j, GGobiData *, ggobid *);
...
//void      tsplot_menus_make (displayd *, ggobid *gg);
//GtkWidget *tsplot_pmode_menu_make (GtkAccelGroup *, GtkSignalFunc, ggobid *gg, gboolean);
//GtkWidget *tsplot_imode_menu_make (GtkAccelGroup *, GtkSignalFunc, ggobid *gg, gboolean);
...
//GtkWidget *barchart_pmode_menu_make (GtkAccelGroup *accel_group, GtkSignalFunc func, ggobid *gg, gboolean useIds);
//GtkWidget *barchart_imode_menu_make (GtkAccelGroup *accel_group, GtkSignalFunc func, ggobid *gg, gboolean useIds);
