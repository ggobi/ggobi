...
gboolean   build_symbol_vectors_by_var (cpaneld *, GGobiStage *, ggobid *);
...
GGobiStage*     datad_get_from_notebook (GtkWidget *notebook, ggobid *);
void       datad_record_id_add (gchar *ids, GGobiStage *d);
...
gboolean   exclude_link_by_id (guint k, GGobiStage *source_d, ggobid *gg);
...
void       limits_set (GGobiStage *, gboolean do_raw, gboolean do_tform, gboolean);  
void       limits_set_by_var (GGobiStage *, guint, gboolean do_raw, gboolean do_tform, gboolean);  
...
void       reset_pp(GGobiStage *, gint, gint, ggobid *, void *);
...
void       subset_apply (GGobiStage *);
gboolean   subset_block (gint, gint, GGobiStage *);
gboolean   subset_everyn (gint, gint, GGobiStage *);
void       subset_set_all(GGobiStage *d, gboolean value);
gboolean   subset_random (gint, GGobiStage *);
gboolean   subset_range (GGobiStage *d);
gboolean   subset_rowlab (gchar *, gint pos, gboolean casep, GGobiStage *);
gboolean   subset_sticky (GGobiStage *);
void       subset_window_open (ggobid *);
gboolean   symbol_link_by_id (gboolean persistentp, gint k, GGobiStage *source_d, ggobid *gg);
...
void       tour1d_realloc_down (gint nc, gint *cols, GGobiStage *d, ggobid *gg);
...
void       tour2d_realloc_down (gint nc, gint *cols, GGobiStage *d, ggobid *gg);
...
void       tourcorr_realloc_down (gint nc, gint *cols, GGobiStage *d, ggobid *gg);
...
void       variable_notebook_subwindow_add (GGobiStage *d, GtkSignalFunc func, gpointer func_data, GtkWidget *notebook, GGobiVariableType, datatyped, ggobid *gg);
