...
gboolean   impute_fixed (ImputeType, gfloat val, int nvars, gint *vars, GGobiData *);
gboolean   impute_mean_or_median (gint, gint, gint *, GGobiData *);
void       impute_random (GGobiData *, gint nvars, gint *vars);
...
void       limits_set_by_var (GGobiData *, guint, gboolean do_raw, gboolean do_tform, gboolean);  
...
guint create_explicit_variable (GGobiData * d, gchar * vname, NewVariableType vartype);
...
void       subset_apply (GGobiData *);
gboolean   subset_block (gint, gint, GGobiData *);
gboolean   subset_everyn (gint, gint, GGobiData *);
void       subset_set_all(GGobiData *d, gboolean value);
gboolean   subset_random (gint, GGobiData *);
gboolean   subset_range (GGobiData *d);
gboolean   subset_rowlab (gchar *, gint pos, gboolean casep, GGobiData *);
gboolean   subset_sticky (GGobiData *);
...
void       tform_to_world_by_var (GGobiData *, guint j);
...
void       variable_notebook_subwindow_add (GGobiData *d, GtkSignalFunc func, gpointer func_data, GtkWidget *notebook, GGobiVariableType, datatyped, ggobid *gg);
...
GGobiVariable* vartable_element_new (GGobiData *d);
