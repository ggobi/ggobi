...
void       br_color_ids_alloc (datad *);
void       br_color_ids_init (datad *);
...
gint  	   get_one_selection_from_tree_view (GtkWidget *tree_view, datad *d);
...
displayd*  parcoords_new_with_vars (gboolean, gint, gint *, datad *, ggobid *);
displayd*  parcoords_new (displayd *dpy, gboolean, gint, gint *, datad *, ggobid *);
...
displayd*  scatmat_new (displayd *, gboolean, gint, gint *, gint, gint *, datad *, ggobid *);
...
void       variable_notebook_subwindow_add (datad *d, GtkSignalFunc func, gpointer func_data, GtkWidget *notebook, vartyped, datatyped, ggobid *gg);
...
gboolean   vartable_iter_from_varno(gint var, datad *d, GtkTreeModel **model, GtkTreeIter *iter);
...
displayd* tsplot_new (displayd *, gboolean, gint, gint *, datad *, ggobid *);
displayd *tsplot_new_with_vars (gboolean missing_p, gint nvars, gint *vars, datad *d, ggobid *gg) ;
...
displayd *createBarchart(displayd *display, gboolean missing_p, splotd * sp, gint var, datad * d,  ggobid * gg);
