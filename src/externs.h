...
void       splot_add_diamond_cue (gint k, splotd *sp, cairo_t *cr, ggobid *gg);
...
void       splot_edges_draw (splotd *sp, gboolean hiddens_p, cairo_t *cr, ggobid *gg);
...
void      barchart_scaling_visual_cues_draw (splotd *sp, cairo_t *cr, ggobid *gg);
gboolean  barchart_active_paint_points (splotd *sp, GGobiData *, ggobid *); 
void      barchart_add_bar_cues (splotd *sp, cairo_t *cr, ggobid *gg);
...
void       scatterXYAddPlotLabels(splotd *sp, cairo_t *cr);
void       scatter1DAddPlotLabels(splotd *sp, cairo_t *cr);
gboolean   processRestoreFile(const gchar * const fileName, ggobid *gg);
