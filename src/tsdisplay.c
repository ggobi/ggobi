...
{
  gtk_widget_set_tooltip_text ((wx), gg->tips ? ("Select to replace the horizontal (time) variable.") : NULL);
  gtk_widget_set_tooltip_text ((wy), gg->tips ? ("Select to delete or append a Y variable; drag plots to reorder.") : NULL);
  gtk_widget_set_tooltip_text ((label), gg->tips ? ("Click left to replace the horizontal (time) variable.  Click middle or right to append or delete a Y variable; drag plots to reorder.") : NULL);
}
