...
cpanel_tsplot_make (ggobid * gg)
{
  ...
  cpanel = gtk_box_new (GTK_ORIENTATION_VERTICAL, VBOX_SPACING);
...
*/
  ...
  gtk_widget_set_tooltip_text ((opt), gg->tips ? ("Arrange the time series as single plot or several plots") : NULL);
