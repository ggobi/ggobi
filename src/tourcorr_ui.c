...
*/
  ...
  gtk_widget_set_tooltip_text ((tgl), gg->tips ? ("Synchronize the horizontal and vertical axes") : NULL);
...
*/
  ...
  gtk_widget_set_tooltip_text ((btn), gg->tips ? ("Open panel for correlation tour projection pursuit") : NULL);
  gtk_box_pack_start (GTK_BOX (panel->w),
                      btn, false, false, 1);
  g_signal_connect (G_OBJECT (btn), "clicked",
...
*/
  ...
  gtk_widget_set_tooltip_text ((btn), gg->tips ? ("Open panel for additional correlation tour features") : NULL);
  gtk_box_pack_start (GTK_BOX (panel->w),
                      btn, false, false, 1);
  g_signal_connect (G_OBJECT (btn), "clicked",
