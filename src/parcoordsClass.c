...
static GdkSegment *
allocWhiskers (GdkSegment * whiskers, GGobiStage *d)
{
  return ((GdkSegment *) g_realloc (whiskers, 2 * d->n_rows * sizeof (GdkSegment)));
}
...
{
  withinDrawBinned(sp, m, drawable, gc);
}
