...
static void tourcorr_io_cb (GtkWidget *w, gpointer *cbd) {
  gchar *lbl = (gchar *) cbd;
  g_printerr ("cbd: %s\n", lbl);
}
...
*/
  ...
  gtk_widget_show_all (gg->tourcorr.io_menu);
}
