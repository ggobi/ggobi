...
/* external functions */
static void open_gtouradv_popup ();

extern void open_gtourpp_popup ();
...
*/
    ...
    gtk_signal_connect (GTK_OBJECT (btn), "clicked",
                       GTK_SIGNAL_FUNC (go_cb), (gpointer) NULL);
    gtk_signal_connect (GTK_OBJECT (tgl), "toggled",
...
void
splot_toggle_gtour_handlers (splotd *sp, gpointer stateptr) {
