...
/* external functions */
static void open_ctouradv_popup ();

extern void open_ctourpp_popup ();
...
void
splot_toggle_ctour_handlers (splotd *sp, gpointer stateptr) {
