...
button while you drag the cursor. The coefficent corresponding to
...
to the projection of the first active variable.  Scramble set the view
...
active variables. Scramble set the view to a random projection.
...
variables. Scramble set the view to a random projection.
