...
\begin{verbatim}
 USER_OBJECT_ x, y, args;

  args = allocVector(VECSXP, 2);
  PROTECT(args);
  VECTOR_DATA(args)[0] = variableToRS(xindex);
  VECTOR_DATA(args)[1] = variableToRS(yindex);

  callUserFunction(RS_smootherFunction, args);
