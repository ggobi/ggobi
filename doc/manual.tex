...
linoleic, linolenic, arachidic, eicosenoic) found in the lipid
fraction of 572 Italian olive oils. There are 9 collection areas, 4
from southern Italy (North and South Apulia, Calabria, Sicily), two
...
up a unix terminal and type {\tt ggobi} (linux) or {\tt open-x11
ggobi} (Mac). 
...
\centerline{\pdfimage width 3in {Figures/olive1.png}
      \pdfimage width 2.9in {Figures/olive2.png}
}
...
\begin{figure}[htp]
\centerline{\pdfimage width 3in {Figures/olive-brush1.png}
      \pdfimage width 3in {Figures/olive-brush2.png}
}
