...
See section \ref{slbl:ColorSchemes} for a description of the
\Widget{Color Schemes} tool, and section
\ref{slbl:ColorAndGlyphGroups} for the \Widget Color \& glyph groups}
tool.
