...
enum {CLIST_VARNO, CLIST_VARNAME, CLIST_TFORM, CLIST_USER_MIN, CLIST_USER_MAX, CLIST_DATA_MIN,
      CLIST_DATA_MAX, CLIST_MEAN, CLIST_MEDIAN, CLIST_NMISSING, NCOLS_CLIST};
#if 0
